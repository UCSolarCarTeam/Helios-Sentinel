...
Item {
    width: 550
    height: 650
    property var motorDetailsElysia:motorDetailsElysia0
   ...
   Column{
       ...
       ComboBox {
           ...
           onCurrentIndexChanged: {
               motorDetailsElysia = currentIndex === 0 ? motorDetailsElysia0 : motorDetailsElysia1;
           }
       }
       ...
       Row{
           ...
           Column{
               ...
               FloatSpinBox {
                   ...
                   onInputValueChanged: motorDetailsElysia.setSlipSpeed(inputValue)
               }
           }
       }
       BytePreview {
