...
public:
    ...
    DEFINE_WHOLE_NUMBER(unsigned char, GpsMinute, 7, 1)
    DEFINE_WHOLE_NUMBER(unsigned char, GpsSecond, 8, 1)
    ...
    DEFINE_WHOLE_NUMBER(float, GpsLongitude, 12, 4)
    DEFINE_WHOLE_NUMBER(float, GpsLatitude, 16, 4)
    ...
    DEFINE_WHOLE_NUMBER(unsigned short, MpuRotationX, 26, 2)
    DEFINE_WHOLE_NUMBER(unsigned short, MpuRotationY, 28, 2)
    DEFINE_WHOLE_NUMBER(unsigned short, MpuRotationZ, 30, 2)
    DEFINE_WHOLE_NUMBER(unsigned short, MpuTemperature, 32, 2)
