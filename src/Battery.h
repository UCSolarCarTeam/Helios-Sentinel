...
public:
    ...
    DEFINE_PROPERTY_INT(int, PopulatedCells,4,1 )
    ...
    DEFINE_PROPERTY_INT(int, HighTemp, 33, 1)
    DEFINE_PROPERTY_INT(int, HighThermistorId, 34, 1)
    DEFINE_PROPERTY_INT(int, LowTemp, 35, 1)
    DEFINE_PROPERTY_INT(int, LowThermistorId, 36, 1)
    DEFINE_PROPERTY_INT(int, AvgTemp, 37, 1)
    DEFINE_PROPERTY_INT(int, InternalTemp, 38, 1)
    DEFINE_PROPERTY_INT(int, FanSpeed, 39, 1)
    DEFINE_PROPERTY_INT(int, ReqFanSpeed, 40, 1)
    DEFINE_PROPERTY_INT(int, LowCellVoltage, 41, 2)
    DEFINE_PROPERTY_INT(int, LowCellVoltageId, 43, 1)
    DEFINE_PROPERTY_INT(int, HighCellVoltage, 44, 2)
    DEFINE_PROPERTY_INT(int, HighCellVoltageId, 46, 1)
    DEFINE_PROPERTY_INT(int, AvgCellVoltage, 47, 2)
