...
public:
    ...
    DEFINE_BOOL(MalfunctionIndicator, 3, 0x08)
    DEFINE_BOOL(MultiPurposeInputSignal, 3, 0x10)
    ...
    DEFINE_WHOLE_NUMBER(int, LowThermistorId, 36, 1)
    DEFINE_WHOLE_NUMBER(int, AvgTemp, 37, 1)
    DEFINE_WHOLE_NUMBER(int, InternalTemp, 38, 1)
    DEFINE_WHOLE_NUMBER(int, FanSpeed, 39, 1)
    DEFINE_WHOLE_NUMBER(int, ReqFanSpeed, 40, 1)
    DEFINE_WHOLE_NUMBER(int, LowCellVoltage, 41, 2)
    DEFINE_WHOLE_NUMBER(int, LowCellVoltageId, 43, 1)
    DEFINE_WHOLE_NUMBER(int, HighCellVoltage, 44, 2)
