...
public:
    ...
    DEFINE_PROPERTY_INT(unsigned short, AuxillaryBatteryVoltage, 5, 2)
    DEFINE_PROPERTY_INT(unsigned short, MotorVoltage, 7, 2)
    DEFINE_PROPERTY_INT(unsigned short, ArrayVoltage, 9, 2)
    DEFINE_PROPERTY_INT(unsigned short, LvVoltage, 11, 2)
    DEFINE_PROPERTY_INT(unsigned short, ChargeVoltage, 13, 2)
    DEFINE_PROPERTY_INT(unsigned short, CommonCurrent, 15, 2)
    DEFINE_PROPERTY_INT(unsigned short, MotorCurrent, 17, 2)
    DEFINE_PROPERTY_INT(unsigned short, ArrayCurrent, 19, 2)
    DEFINE_PROPERTY_INT(unsigned short, LvCurrent, 21, 2)
    DEFINE_PROPERTY_INT(unsigned short, ChargeCurrent, 23, 2)
