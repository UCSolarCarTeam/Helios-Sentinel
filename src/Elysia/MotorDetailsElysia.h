...
public:
    ...
    DEFINE_WHOLE_NUMBER(int, PhaseCCurrent, 2, 4)
    DEFINE_WHOLE_NUMBER(int, PhaseBCurrent, 6, 4)
    DEFINE_WHOLE_NUMBER(int, MotorVoltageReal, 10, 4)
    DEFINE_WHOLE_NUMBER(int, MotorVoltageImag, 14, 4)
    DEFINE_WHOLE_NUMBER(int, MotorCurrentReal, 18, 4)
    DEFINE_WHOLE_NUMBER(int, MotorCurrentImag, 22, 4)
    DEFINE_WHOLE_NUMBER(int, BlackEMF, 26, 4)
    DEFINE_WHOLE_NUMBER(int, VoltageRailSupply15, 30, 4)
    DEFINE_WHOLE_NUMBER(int, VoltageRailSupply3, 34, 4)
    DEFINE_WHOLE_NUMBER(int, VoltageRailSupply2, 38, 4)
    DEFINE_WHOLE_NUMBER(int, HeatSinkTemp, 42, 4)
    DEFINE_WHOLE_NUMBER(int, MotorTemp, 46, 4)
    DEFINE_WHOLE_NUMBER(int, DspBoardTemp, 50, 4)
    DEFINE_WHOLE_NUMBER(int, DcBusAmpHours, 54, 4)
    DEFINE_WHOLE_NUMBER(int, Odometer, 58, 4)
    DEFINE_WHOLE_NUMBER(int, SlipSpeed, 62, 4)
