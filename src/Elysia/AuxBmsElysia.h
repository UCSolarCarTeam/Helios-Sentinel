...
public:
    ...
    DEFINE_WHOLE_NUMBER(int, PrechargeState,2,1 )
    DEFINE_WHOLE_NUMBER(int, AuxVoltage, 3,1)
    DEFINE_BOOL(BmsAlive, 4, 0x01)
    DEFINE_BOOL(StrobeLight, 5, 0x01)
    DEFINE_BOOL(AllowCharge, 6, 0x01)
    DEFINE_BOOL(HighVoltageEnable, 7, 0x01)
    DEFINE_BOOL(AllowDischarge, 8, 0x01)
    DEFINE_BOOL(OrionRecieved, 9, 0x01)
    DEFINE_BOOL(ChargeContactor, 10, 0x01)
    DEFINE_BOOL(DischargeContactor, 10, 0x02)
    DEFINE_BOOL(CommonContactor, 10, 0x04)
    DEFINE_BOOL(DischargeShould, 10, 0x08)
    DEFINE_BOOL(ChargeShould, 10, 0x10)
    DEFINE_BOOL(ChargeOpen, 10, 0x20)
    DEFINE_BOOL(DischargeOpen, 10, 0x40)
    DEFINE_BOOL(CtHighCellVoltage, 11, 0x01)
    DEFINE_BOOL(CtHighTempCurrent, 11, 0x02)
    DEFINE_BOOL(CtPackCurrent, 11, 0x04)
    DEFINE_BOOL(DtLowCellVoltage, 11, 0x08)
    DEFINE_BOOL(DtHighTempCurrent, 11, 0x10)
    DEFINE_BOOL(DtPackCurrent, 11, 0x20)
    DEFINE_BOOL(Protection, 11, 0x40)
