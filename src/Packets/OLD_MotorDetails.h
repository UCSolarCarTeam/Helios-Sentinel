...
class MotorDetails : public QObject {
    ...
    DEFINE_BOOL(MotorAboutToStall, 16, MOTOR_ABOUT_TO_STALL_MASK)
    DEFINE_BOOL(DelayInReadingTempSensor, 16, DELAY_IN_READING_TEMP_SENSOR_MASK)
    DEFINE_BOOL(DelayInReadingPosSensor, 16, DELAY_IN_READING_POS_SENSOR_MASK)
    DEFINE_BOOL(Inverter1TempVeryHigh, 16, INVERTER_1_TEMP_VERY_HIGH_MASK)
    DEFINE_BOOL(Inverter2TempVeryHigh, 16, INVERTER_2_TEMP_VERY_HIGH_MASK)
    DEFINE_BOOL(Inverter3TempVeryHigh, 16, INVERTER_3_TEMP_VERY_HIGH_MASK)
    DEFINE_BOOL(Inverter4TempVeryHigh, 16, INVERTER_4_TEMP_VERY_HIGH_MASK)
    DEFINE_BOOL(Inverter5TempVeryHigh, 16, INVERTER_5_TEMP_VERY_HIGH_MASK)
    DEFINE_BOOL(Inverter6TempVeryHigh, 18, INVERTER_6_TEMP_VERY_HIGH_MASK)
    DEFINE_BOOL(CpuTemperatureVeryHigh, 18, CPU_TEMPERATURE_VERY_HIGH_MASK)
    DEFINE_BOOL(HallTemperatureVeryHigh, 18, HALL_TEMPERATURE_VERY_HIGH_MASK)
    DEFINE_BOOL(DclinkTemperatureVeryHigh, 18, DCLINK_TEMPERATURE_VERY_HIGH_MASK)
    DEFINE_BOOL(DelayInDclinkCommunication, 18, DELAY_IN_DCLINK_COMMUNICATION_MASK)
    DEFINE_BOOL(Inverter1OverCurrentWarning, 18, INVERTER_1_OVERCURRENT_WARNING_MASK)
    DEFINE_BOOL(Inverter2OverCurrentWarning, 18, INVERTER_2_OVERCURRENT_WARNING_MASK)
    DEFINE_BOOL(Inverter3OverCurrentWarning, 18, INVERTER_3_OVERCURRENT_WARNING_MASK)
    DEFINE_BOOL(Inverter4OverCurrentWarning, 20, INVERTER_4_OVERCURRENT_WARNING_MASK)
    DEFINE_BOOL(Inverter5OverCurrentWarning, 20, INVERTER_5_OVERCURRENT_WARNING_MASK)
    DEFINE_BOOL(Inverter6OverCurrentWarning, 20, INVERTER_6_OVERCURRENT_WARNING_MASK)
    DEFINE_BOOL(DcOvervoltageWarning, 20, DC_OVERVOLTAGE_WARNING_MASK)
    DEFINE_BOOL(DcUndervoltageWarning, 20, DC_UNDERVOLTAGE_WARNING_MASK)
    DEFINE_BOOL(CanCommsTimeout, 20, CAN_COMMS_TIMEOUT_MASK)
    DEFINE_BOOL(Inverter1faultWarning, 20, INVERTER_1_FAULT_WARNING_MASK)
    DEFINE_BOOL(Inverter2faultWarning, 20, INVERTER_2_FAULT_WARNING_MASK)
    DEFINE_BOOL(Inverter3faultWarning, 22, INVERTER_3_FAULT_WARNING_MASK)
    DEFINE_BOOL(Inverter4faultWarning, 22, INVERTER_4_FAULT_WARNING_MASK)
    DEFINE_BOOL(Inverter5faultWarning, 22, INVERTER_5_FAULT_WARNING_MASK)
    DEFINE_BOOL(Inverter6faultWarning, 22, INVERTER_6_FAULT_WARNING_MASK)
    DEFINE_BOOL(CanSendWarning, 22, CAN_SEND_WARNING_MASK)
    DEFINE_BOOL(LostFramesOnCanBusWarning, 22, LOST_FRAMES_ON_CAN_BUS_WARNING_MASK)
    DEFINE_BOOL(OverspeedWarning, 22, OVERSPEED_WARNING_MASK)
    DEFINE_BOOL(CpuOverload, 22, CPU_OVERLOAD_MASK)
    DEFINE_BOOL(TorqueLimited, 24, TORQUE_LIMITED_MASK)
    DEFINE_BOOL(StartAtHighRpm, 24, START_AT_HIGH_RPM_MASK)

    DEFINE_BOOL(InitError, 25, INIT_ERROR_MASK)
    DEFINE_BOOL(SettingsNotFound, 25, SETTINGS_NOT_FOUND_MASK)
    DEFINE_BOOL(MotorStalled, 25, MOTOR_STALLED_MASK)
    DEFINE_BOOL(ControllerDataReadingTimeout, 25, CONTROLLER_DATA_READING_TIMEOUT_MASK)
    DEFINE_BOOL(InvalidHallSensorSequence, 25, INVALID_HALL_SENSOR_SEQUENCE_MASK)
    DEFINE_BOOL(InvalidHallSector, 25, INVALID_HALL_SECTOR_MASK)
    DEFINE_BOOL(ErrorReadingTempSensor, 25, ERROR_READING_TEMP_SENSOR_MASK)
    DEFINE_BOOL(PositionSensorReadingError, 25, POSITION_SENSOR_READING_ERROR_MASK)
    DEFINE_BOOL(ErrorReadingEncoder, 27, ERROR_READING_ENCODER_MASK)
    DEFINE_BOOL(ZeroPositionOffsetNotSet, 27, ZERO_POSITION_OFFSET_NOT_SET_MASK)
    DEFINE_BOOL(HwEnableNotSet, 27, HW_ENABLE_NOT_SET_MASK)
    DEFINE_BOOL(Inverter1TempTooHigh, 27, INVERTER_1_TEMP_TOO_HIGH_MASK)
    DEFINE_BOOL(Inverter2TempTooHigh, 27, INVERTER_2_TEMP_TOO_HIGH_MASK)
    DEFINE_BOOL(Inverter3TempTooHigh, 27, INVERTER_3_TEMP_TOO_HIGH_MASK)
    DEFINE_BOOL(Inverter4TempTooHigh, 27, INVERTER_4_TEMP_TOO_HIGH_MASK)
    DEFINE_BOOL(Inverter5TempTooHigh, 27, INVERTER_5_TEMP_TOO_HIGH_MASK)
    DEFINE_BOOL(Inverter6TempTooHigh, 29, INVERTER_6_TEMP_TOO_HIGH_MASK)
    DEFINE_BOOL(CpuTemperatureTooHigh, 29, CPU_TEMPERATURE_TOO_HIGH_MASK)
    DEFINE_BOOL(HallTemperatureTooHigh, 29, HALL_TEMPERATURE_TOO_HIGH_MASK)
    DEFINE_BOOL(DclinkTemperatureTooHigh, 29, DCLINK_TEMPERATURE_TOO_HIGH_MASK)
    DEFINE_BOOL(ErrorInDclinkCommunication, 29, ERROR_IN_DCLINK_COMMUNICATION_MASK)
    DEFINE_BOOL(Inverter1OvercurrentError, 29, INVERTER_1_OVERCURRENT_ERROR_MASK)
    DEFINE_BOOL(Inverter2OvercurrentError, 29, INVERTER_2_OVERCURRENT_ERROR_MASK)
    DEFINE_BOOL(Inverter3OvercurrentError, 29, INVERTER_3_OVERCURRENT_ERROR_MASK)
    DEFINE_BOOL(Inverter4OvercurrentError, 31, INVERTER_4_OVERCURRENT_ERROR_MASK)

    DEFINE_BOOL(Inverter5OvercurrentError, 31, INVERTER_5_OVERCURRENT_ERROR_MASK)
    DEFINE_BOOL(Inverter6OvercurrentError, 31, INVERTER_6_OVERCURRENT_ERROR_MASK)
    DEFINE_BOOL(DcOvervoltageError, 31, DC_OVERVOLTAGE_ERROR_MASK)
    DEFINE_BOOL(DcUndervoltageError, 31, DC_UNDERVOLTAGE_ERROR_MASK)
    DEFINE_BOOL(DoubleCanIdOnBus, 31, DOUBLE_CAN_ID_ON_BUS_MASK)
    DEFINE_BOOL(CanCommsTimeoutError, 31, CAN_COMMS_TIMEOUT_ERROR_MASK)
    DEFINE_BOOL(Inverter1FaultError, 31, INVERTER_1_FAULT_ERROR_MASK)
    DEFINE_BOOL(Inverter2FaultError, 32, INVERTER_2_FAULT_ERROR_MASK)
    DEFINE_BOOL(Inverter3FaultError, 32, INVERTER_3_FAULT_ERROR_MASK)
    DEFINE_BOOL(Inverter4FaultError, 32, INVERTER_4_FAULT_ERROR_MASK)
    DEFINE_BOOL(Inverter5FaultError, 32, INVERTER_5_FAULT_ERROR_MASK)
    DEFINE_BOOL(Inverter6FaultError, 32, INVERTER_6_FAULT_ERROR_MASK)
    DEFINE_BOOL(CanSendError, 32, CAN_SEND_ERROR_MASK)
    DEFINE_BOOL(LostFramesOnCanBusError, 32, LOST_FRAMES_ON_CAN_BUS_ERROR_MASK)
    DEFINE_BOOL(OverspeedError, 32, OVERSPEED_ERROR_MASK)
