...
class Mppt : public IPacket {
    ...
    DEFINE_PROPERTY(unsigned long long, M0C0, 0x600)
    ...
    DEFINE_PROPERTY(unsigned long long, M0C1, 0x601)
    ...
    DEFINE_PROPERTY(unsigned long long, M1C0, 0x602)
    ...
    DEFINE_PROPERTY(unsigned long long, M1C1, 0x603)
    ...
    DEFINE_PROPERTY(unsigned long long, M2C0, 0x604)
    ...
    DEFINE_PROPERTY(unsigned long long, M2C1, 0x605)
    ...
    DEFINE_PROPERTY(unsigned long long, M3C0, 0x606)
    ...
    DEFINE_PROPERTY(unsigned long long, M3C1, 0x607)
