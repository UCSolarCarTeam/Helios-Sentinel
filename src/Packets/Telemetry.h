...
class Telemetry : public IPacket {
    ...
    DEFINE_PROPERTY(unsigned long long, GpsTime)
    ...
    DEFINE_PROPERTY(unsigned int, GpsFlags)
    ...
    DEFINE_PROPERTY(unsigned long long, MpuGyroscope)
    ...
    DEFINE_PROPERTY(short, MpuTemperature)
