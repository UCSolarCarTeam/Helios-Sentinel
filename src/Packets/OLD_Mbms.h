...
public:
    ...
    DEFINE_BOOL(HighCellVoltageTrip, 25, 0x01)
    DEFINE_BOOL(LowCellVoltageTrip, 25, 0x02)
    DEFINE_BOOL(HighCommonCurrentTrip, 25, 0x04)
    DEFINE_BOOL(MotorTCTrip, 25, 0x08)
    DEFINE_BOOL(ArrayTCTrip, 25, 0x10)
    DEFINE_BOOL(LvTCTrip, 25, 0x20)
    DEFINE_BOOL(ChargeTCTrip, 25, 0x40)
    DEFINE_BOOL(ProtectionTrip, 25, 0x80)
    DEFINE_BOOL(OrionMessageTimeoutTrip, 26, 0x01)
    DEFINE_BOOL(ContactorDisconnectedTrip, 26, 0x02)
