...
public:
    ...
    DEFINE_BOOL(RaceMode, 3, 0x01)
    DEFINE_BOOL(Lap, 3, 0x02)
    DEFINE_BOOL(ZoomZoom, 3, 0x04)

    DEFINE_BOOL(ForwardSwitch, 4, 0x01)
    DEFINE_BOOL(HornSwitch, 4, 0x02)
    DEFINE_BOOL(Forward, 4, 0x04)
    DEFINE_BOOL(Neutral, 4, 0x08)
    DEFINE_BOOL(Reverse, 4, 0x10)
    DEFINE_BOOL(BrakeSwitch, 4, 0x20)
    DEFINE_BOOL(HandbrakeSwitch, 4, 0x40)
    DEFINE_BOOL(MotorReset, 4, 0x80)
